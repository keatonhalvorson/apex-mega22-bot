...
# --- Settings ---
SYMBOL = "VOLIDXUSD"
PRICE_DIVISOR = 100.0   # VIX divisor is 100 (2 decimal places)
MAX_WORKERS = 12        # Number of concurrent threads for downloading active hours
OUTPUT_FILE = "vix_ticks_1y.csv"
...
def run_download(start_date_str, end_date_str, dry_run=False):
    ...
    print("╔══════════════════════════════════════════════════════╗")
    print("║   DUCASCOPY VOLATILITY INDEX (VIX) TICK DOWNLOADER   ║")
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Dukascopy VIX Tick Downloader")
