...
def run_dynamic_backtest():
    ...
    print(f"📈 Testing dynamic regime strategy at {len(test_indices)} points over the last 30 days...")
    ...
    while i < len(results):
        ...
        if decision in ['BUY', 'SHORT'] and confidence >= 0.65:
            if not guardrail_passed:
                print(f"   [⚠️ GUARDRAIL BLOCKED] Blocked counter-trend {decision} trade at {res['timestamp']} | {reason_blocked}")
                i += 1
                continue
    ...
    print("\n=======================================================")
    print("   DYNAMIC REGIME FUNDED CHALLENGE 30-DAY BACKTEST     ")
    print("=======================================================")
