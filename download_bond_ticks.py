...
# --- Settings ---
SYMBOL = "USTBONDTRUSD"
PRICE_DIVISOR = 1000.0  # US Bond divisor is 1000 (3 decimal places)
MAX_WORKERS = 12        # Number of concurrent threads for downloading active hours
OUTPUT_FILE = "ustbond_ticks_1y.csv"
...
def run_download(start_date_str, end_date_str, dry_run=False):
    ...
    print("╔══════════════════════════════════════════════════════╗")
    print("║   DUCASCOPY US TREASURY BOND (USTBOND) TICK DOWNLOAD ║")
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Dukascopy US Bond Tick Downloader")
